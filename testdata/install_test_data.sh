...
opal file --opal https://datashield_opal:8443 -u administrator -p password -up /testdata/LifeLines.sav /projects
...
opal import-sav --opal https://datashield_opal:8443 --user administrator --password password --path /projects/LifeLines.sav --destination test